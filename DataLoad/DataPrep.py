...
def DataLoad(location, split_size=None, pairs=5):  # , size
    ...
    sets = []  # This list is for monitoring the image_a and image_b combinations - train data
    test_sets = []  # This list is for monitoring the image_a and image_b combinations -test data
