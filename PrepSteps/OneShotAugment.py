...
def FindMax(location, at_least = None):
    ...
    +                                                                            +
    + Prints the number of categories left based on the thrushold the user gives +
    +                                                                            +
    +  IMPORTANT:                                                                +
    +                                                                            +
    ...
    '''
       ...
       + for the maximation of the size of the final dataset            +
       ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    print('The maximum size this dataset could be, after the augmentation is ',size,
          '\nIf we keep thecategories with at least {} images'.format(k), 
    ...
    if at_least is not None:
        ...
        print('Note: You did not specify a thrushold for the minimum acceptable number of images per category')
...
def AugmentSteps(elem,l,r):
    ...
    #plt.imsave('{}\\rotated{}.png'.format(l,r), rotated_image, cmap='Greys')
    ...
    #plt.imsave('{}\\flipped_ver{}.png'.format(l,r), flip_vr_image, cmap='Greys')
    ...
    #plt.imsave('{}\\cropped{}.png'.format(l,r), crop_image, cmap='Greys')
